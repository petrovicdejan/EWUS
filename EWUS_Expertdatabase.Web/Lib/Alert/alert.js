...
function locks_init() {
    var el = $('.lock-overlay');
    if (!el || !el.html()) {
        var strHtml = '<div class="lock-overlay"><div class="lock-box"></div></div>';
        $('body').append(strHtml);
        el = $('.lock-overlay');
    }
    return el;
...
function showlockscreen() {
    var overlay = locks_init();
    var box = overlay.find('.lock-box');
    var uri = sRootUrl + "/Lib/App/Views/Account/lockscreen.html";
